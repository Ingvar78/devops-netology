...
1. Могут ли файлы, являющиеся жесткой ссылкой на один объект, иметь разные права доступа и владельца? Почему?
    ...
    Жесткие ссылки:
       ...
       связаны с содержимым исходного файла. если создать жесткую ссылку на файл и изменить содержимое файла (или ссылки), то изменения будут присутствовать в обоих объектах;

       с помощью жесткой ссылки возможно просматривать содержимое файла, даже если исходный файл перемещен или удален;

       если удалить жесткую ссылку, то связанный с ней файл будет существовать, пока существует хотя бы одна жесткая ссылка на него;

       если удалить исходный файл, но при этом в другом месте сохранится жесткая ссылка на него, то «сменится» каталог размещения файла;
