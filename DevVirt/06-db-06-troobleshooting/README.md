...
Объемные запросы на миллионы строк (в нашем случае выросла БД и количество записей в ней) - рекомендуется изменение параметра net_read_timeout в сторону увеличения. 
...
При исчезновении ошибки определить пороговые значения изменённых параметров при которых приложение работает стабильно, т.к. простое увеличение данных параметров может повлиять на работу приложений в целом.
